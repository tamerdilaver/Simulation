...
//		fGetBeta(iSIMS,  &dBeta_0);
	...
	SetDrawWindow("Covariance Stat. Region GARCH");
	decl iArea = 0;
...
//	vBeta[0] = dALPHA * (3)/dLAMBDA;
	...
	//	fGetBeta(iSIMS,  &dBeta_0);
		...
		//vBeta[i] = dALPHA * (3)/dLAMBDA;
		vBeta[i] = dALPHA;
	
//		if(1 + (6/(dLAMBDA*(dLAMBDA+1)) -1)*dALPHA>0){
//			vBeta[i] = 1 + (6/(dLAMBDA*(dLAMBDA+1)) -1)*dALPHA;
//	   	}else{
//			vBeta[i] = .NaN;
//		}
	...
	SetDrawWindow("Covariance Stat. Region T-GAS");
	 iArea = 0;
